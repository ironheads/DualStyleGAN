...
from util import data_sampler, requires_grad, accumulate, sample_data, d_logistic_loss, d_r1_loss, g_nonsaturating_loss, g_path_regularize, make_noise, mixing_noise, set_grad_none,settings
...
if __name__ == "__main__":
    ...
    parser = settings("StyleGAN Finetune")
    ...
    parser.add_argument("--n_sample", type=int, default=9, help="number of the samples generated during training")
    ...
    parser.add_argument("--save_every", type=int, default=10000, help="interval of saving a checkpoint")
    parser.add_argument("--style", type=str, default='cartoon', help="style type")
    parser.add_argument("--model_path", type=str, default='./checkpoint/', help="path to save the model")
    args = parser.parse()
    if args.local_rank == 0:
        print('*'*50)

    ## check whether there exists the log directory of this style
